...
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource, resource_not_found_exception)
  VALUES ('escidoc:mm-set-definition-create', 'de.escidoc.core.om.service.SetDefinitionHandler', 'create', 'info:escidoc/names:aa:1.0:action:create-set-definition', 
...
INSERT INTO aa.invocation_mappings (id, attribute_id, path, position, attribute_type, mapping_type, multi_value, value, method_mapping)
  VALUES ('escidoc-im-set-definition-create-1', 'info:escidoc/names:aa:1.0:resource:object-type-new', '', 0, 
         ...
         */
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource, resource_not_found_exception)
  VALUES ('escidoc:mm-set-definition-delete', 'de.escidoc.core.om.service.SetDefinitionHandler', 'delete', 'info:escidoc/names:aa:1.0:action:delete-set-definition', 
  true, true, 'de.escidoc.core.common.exceptions.application.notfound.ResourceNotFoundException');
...
INSERT INTO aa.invocation_mappings (id, attribute_id, path, position, attribute_type, mapping_type, multi_value, value, method_mapping)
  VALUES ('escidoc-im-set-definition-delete-1', 'urn:oasis:names:tc:xacml:1.0:resource:resource-id', '', 0, 
         ...
         */
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource, resource_not_found_exception)
  VALUES ('escidoc:mm-set-definition-retrieve', 'de.escidoc.core.om.service.SetDefinitionHandler', 'retrieve', 'info:escidoc/names:aa:1.0:action:retrieve-set-definition', 
  true, true, 'de.escidoc.core.common.exceptions.application.notfound.ResourceNotFoundException');
...
INSERT INTO aa.invocation_mappings (id, attribute_id, path, position, attribute_type, mapping_type, multi_value, value, method_mapping)
  VALUES ('escidoc-im-set-definition-retrieve-1', 'urn:oasis:names:tc:xacml:1.0:resource:resource-id', '', 0, 
         ...
         */
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource, resource_not_found_exception)
  VALUES ('escidoc:mm-set-definition-update', 'de.escidoc.core.om.service.SetDefinitionHandler', 'update', 'info:escidoc/names:aa:1.0:action:update-set-definition', 
  true, true, 'de.escidoc.core.common.exceptions.application.notfound.ResourceNotFoundException');
...
INSERT INTO aa.method_mappings (id, class_name, method_name, action_name, exec_before, single_resource)
  VALUES ('escidoc:mm-om-retrieve-set-definitions', 'de.escidoc.core.om.service.SetDefinitionHandler', 'retrieveSetDefinitions', 
