    /**
     * Role Collaborator-Modifier-Container-Update-any-Members
     */
INSERT INTO aa.escidoc_role
    ...
    CURRENT_TIMESTAMP);
        ...
        /** 
         * Role Collaborator-Modifier-Container-Update-any-Members Scope
         */  
...
INSERT INTO aa.scope_def 
    ...
    ('escidoc:scope-def-role-collaborator-modifier-container-update-any-members-4',
     ...
     'info:escidoc/names:aa:1.0:resource:component:item:container');
        ...
        /**
         * Role Collaborator-Modifier-Container-Update-any-Members Policies
         */
            /**
             * An Collaborator-Modifier-Container-Update-any-Members is allowed to retrieve container.
             */
            /**
             * An Collaborator-Modifier-Container-Update-any-Members is allowed to retrieve items.
             */
            /**
             * An Collaborator-Modifier-Container-Update-any-Members is allowed to retrieve content of components.
             */
            /**
             * An Collaborator-Modifier-Container-Update-any-Members is allowed to modify, lock + unlock containers, items + components.
             */
            /**
             * An Collaborator-Modifier-Container-Update-any-Members is allowed to add items to a container.
             */
