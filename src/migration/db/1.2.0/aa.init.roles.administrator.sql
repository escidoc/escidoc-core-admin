UPDATE aa.scope_def SET attribute_id=NULL WHERE id='escidoc:scope-def-role-administrator-5';

DELETE FROM aa.scope_def WHERE id='escidoc:scope-def-role-administrator-6';
