...
public class ResourceNotFoundException  extends de.escidoc.core.common.exceptions.application.ApplicationException  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://notfound.application.exceptions.common.core.escidoc.de", "ResourceNotFoundException"));
    }
