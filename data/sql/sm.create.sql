...
INSERT INTO "sm"."scopes" (id, xml) VALUES (1,'<?xml version="1.0" encoding="UTF-8"?>
<scope xmlns="http://www.escidoc.de/schemas/scope/0.3" objid="1">
	<name>Scope for Framework</name>
	<type>normal</type>
</scope>');

INSERT INTO "sm"."scopes" (id, xml) VALUES (2,'<?xml version="1.0" encoding="UTF-8"?>
<scope xmlns="http://www.escidoc.de/schemas/scope/0.3" objid="2">
	<name>Admin Scope</name>
	<type>admin</type>
</scope>');

INSERT INTO "sm"."aggregation_definitions" (id, xml, scope_id) VALUES (1, '<?xml version="1.0" encoding="UTF-8"?>
...
INSERT INTO "sm"."aggregation_definitions" (id, xml, scope_id) VALUES (2, '<?xml version="1.0" encoding="UTF-8"?>
...
INSERT INTO "sm"."report_definitions" (id, xml, scope_id) VALUES (1, '<?xml version="1.0" encoding="UTF-8"?><report-definition xmlns="http://www.escidoc.de/schemas/reportdefinition/0.3" objid="1">	<name>Successful Framework Requests</name>   <scope objid="1" />	<sql>		select 		handler, request, day, month, year, sum(requests) 		from _1_request_statistics		group by handler, request, day, month, year;	</sql></report-definition>', 1);

INSERT INTO "sm"."report_definitions" (id, xml, scope_id) VALUES (2, '<?xml version="1.0" encoding="UTF-8"?><report-definition xmlns="http://www.escidoc.de/schemas/reportdefinition/0.3" objid="2">	<name>Unsuccessful Framework Requests</name>  <scope objid="1" />	<sql>		select * 		from _2_error_statistics;	</sql> </report-definition>', 1);
