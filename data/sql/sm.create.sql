...
INSERT INTO sm.report_definitions (id, xml_data, scope_id) VALUES ('2', '<?xml version="1.0" encoding="UTF-8"?><report-definition xmlns="http://www.escidoc.de/schemas/reportdefinition/0.3" objid="2"> <name>Unsuccessful Framework Requests</name>  <scope objid="1" />   <sql>       select *        from _2_error_statistics;   </sql><allowed-roles><allowed-role objid="default-user" /></allowed-roles></report-definition>', '1');

INSERT INTO sm.report_definitions (id, xml_data, scope_id) VALUES ('3', '<?xml version="1.0" encoding="UTF-8"?><report-definition xmlns="http://www.escidoc.de/schemas/reportdefinition/0.3" objid="3"> <name>Successful Framework Requests by Month and Year</name>  <scope objid="1" />   <sql>       select *        from _1_request_statistics      where month = {month} and year = {year};    </sql><allowed-roles><allowed-role objid="default-user" /></allowed-roles></report-definition>', '1');
