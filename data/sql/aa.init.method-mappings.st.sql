...
INSERT INTO "aa"."method_mappings" (id, class_name, method_name, action_name, before, single_resource)
  VALUES ('escidoc:mm-st-create', 'de.escidoc.core.st.service.StagingFileHandler', 'create', 'info:escidoc/names:aa:1.0:action:create-staging-file', true, true);
...
INSERT INTO "aa"."method_mappings" (id, class_name, method_name, action_name, before, single_resource, resource_not_found_exception)
  VALUES ('escidoc:mm-st-retrieve', 'de.escidoc.core.st.service.StagingFileHandler', 'retrieve', 
