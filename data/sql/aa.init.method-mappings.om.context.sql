...
INSERT INTO "aa"."method_mappings" (id, class_name, method_name, action_name, before, single_resource, resource_not_found_exception)
  ...
  'info:escidoc/names:aa:1.0:action:retrieve-context', true, true, 'de.escidoc.core.common.exceptions.application.notfound.ContextNotFoundException');
...
INSERT INTO "aa"."invocation_mappings" (id, attribute_id, path, "position", attribute_type, mapping_type, multi_value, "value", method_mapping)
  VALUES ('escidoc-im-context-retrieve-members-1', 'urn:oasis:names:tc:xacml:1.0:resource:resource-id', '', 0, 
        ...
        /**
         * Context mm - retrieve member refs
         */
INSERT INTO "aa"."method_mappings" (id, class_name, method_name, action_name, before, single_resource, resource_not_found_exception)
  VALUES ('escidoc:mm-context-retrieve-member-refs', 'de.escidoc.core.om.service.ContextHandler', 'retrieveMemberRefs', 
  'info:escidoc/names:aa:1.0:action:retrieve-context', true, true, 'de.escidoc.core.common.exceptions.application.notfound.ContextNotFoundException');

INSERT INTO "aa"."invocation_mappings" (id, attribute_id, path, "position", attribute_type, mapping_type, multi_value, "value", method_mapping)
  VALUES ('escidoc-im-context-retrieve-member-refs-1', 'urn:oasis:names:tc:xacml:1.0:resource:resource-id', '', 0, 
          'http://www.w3.org/2001/XMLSchema#string', 0, false, '', 'escidoc:mm-context-retrieve-member-refs');
...
INSERT INTO "aa"."method_mappings" (id, class_name, method_name, action_name, before, single_resource)
  ...
  'info:escidoc/names:aa:1.0:action:retrieve-objects-filtered', false, true);
        ...
        /**
         * Context mm - retrieve context refs
         */
INSERT INTO "aa"."method_mappings" (id, class_name, method_name, action_name, before, single_resource)
  VALUES ('escidoc:mm-context-retrieve-context-refs', 'de.escidoc.core.om.service.ContextHandler', 'retrieveContextRefs', 
