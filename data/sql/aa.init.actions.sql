...
INSERT INTO "aa"."actions" (id, name) VALUES
	...
	-- OM FedoraManagementDeviationHandler
INSERT INTO "aa"."actions" (id, name) VALUES
    ('escidoc:action-fmdh-export', 'info:escidoc/names:aa:1.0:action:fmdh-export');

	-- OM FedoraAccessDeviationHandler
INSERT INTO "aa"."actions" (id, name) VALUES
    ('escidoc:action-fadh-get-datastream-dissemination', 'info:escidoc/names:aa:1.0:action:fadh-get-datastream-dissemination');

	-- OM FedoraDescribeDeviationHandler
INSERT INTO "aa"."actions" (id, name) VALUES
    ('escidoc:action-fddh-get-fedora-description', 'info:escidoc/names:aa:1.0:action:fddh-get-fedora-description');
